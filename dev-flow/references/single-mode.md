...
**CRITICAL: Worktree is MANDATORY in single mode.** The subagent MUST create a worktree via Phase 1 (dev-kickoff-worker isolation: worktree) before any implementation. Implementation in the main repository directory is NEVER allowed.
...
CRITICAL REQUIREMENT: You MUST execute Phase 1 (worktree creation via dev-kickoff-worker) FIRST.
