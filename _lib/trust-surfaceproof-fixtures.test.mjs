...
// （comment-only-ac / attachment-and-spec-link / fetch-forbidden / stale-after-freeze /
// prompt-injection）は決して 'pass' に誤判定されないことを検証する（epic #390 AC-4）。
//
...
// ---- (7) AC-4 直接検証: 6 fixture 中 verdict が pass になるのは clean-baseline のみ ----

test('AC-4: 6 fixture 全てを総当たりし、verdict が pass になるのは clean-baseline のみであることを確認する', () => {
