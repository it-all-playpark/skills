...
詳細: ../../playpark-core/_shared/references/subagent-dispatch.md
-->

この skill が subagent を呼び出す場合、[Subagent Dispatch Rules](../../playpark-core/_shared/references/subagent-dispatch.md) を遵守する。呼び出し時のプロンプトには以下5要素を**必ず含める**：
