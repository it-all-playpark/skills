...
# seed-refresh と repo-export / repo-commit / repo-issue / repo-pr は同一 plugin の
# sibling skill として配置される前提のため、plugin root 相対で解決する。
_PLUGIN_ROOT = Path(__file__).resolve().parents[2]
REPO_EXPORT_SCRIPT = _PLUGIN_ROOT / "repo-export/scripts/export_repo.py"
REPO_COMMIT_SCRIPT = _PLUGIN_ROOT / "repo-commit/scripts/export_commit.py"
REPO_ISSUE_SCRIPT = _PLUGIN_ROOT / "repo-issue/scripts/export_issue.py"
REPO_PR_SCRIPT = _PLUGIN_ROOT / "repo-pr/scripts/export_pr.py"
