...
```bash
blog-cross-post-resolve-source <slug-or-path>
```
...
- `${CLAUDE_PLUGIN_ROOT}/zenn-publish/references/content-guide.md` - Zennテンプレート・変換ルール・SEO
- `${CLAUDE_PLUGIN_ROOT}/qiita-publish/references/content-guide.md` - Qiitaテンプレート・変換ルール・SEO
...
```bash
# On success
journal log blog-cross-post success \
  --duration-turns $TURNS

# On failure
journal log blog-cross-post failure \
