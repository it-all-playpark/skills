...
| check_targets | ["statistics", "pricing", "versions", "dates", "urls", "entities", "testimonials", "self_claims", "disclosures"] | チェック対象カテゴリ |
| auto_fix_categories | ["statistics", "pricing", "versions", "dates"] | `--fix` 時に自動置換するカテゴリ |
| review_only_categories | ["urls", "entities", "testimonials", "self_claims", "disclosures"] | `--fix` 時に flag のみで human review に回すカテゴリ (フィクションを別のフィクションに書き換えるリスク回避) |
...
| `review_only_categories` | `["urls", "entities", "testimonials", "self_claims", "disclosures"]` |
